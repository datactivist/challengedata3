...
par Elsa Ayache, Camille Buonanno, Loris Garrido, Solena Lefeuvre, Camille Maillet & Jodie Van de Riet ![](https://raw.githubusercontent.com/datactivist/challengedata3/main/images_cdb/nezel.jpeg)
...
**Appel téléphonique avec notre interlocuteur** Discussion autour de chaque point de la wishlist afin d’évaluer la pertinence des thèmes et l’obtention des données
...
* **Difficulté n°1** : Il n’existe aujourd’hui aucune donnée Excel en mairie pour la totalité des catégories demandées que nous avions sélectionner  
...
Nous réalisons en commun la wanted wishlist \(étape 2.4\) ![](https://raw.githubusercontent.com/ArthurSrz/images/main/Nezel_carnet2.png)
...
**14h30:** Nous faisons un point de groupe pour nous répartir les tâches suite à l’appel et nouscomplétons les données du fichier Équipements.
...
Equipements sportifs : le jeu de données est invalidé car il manque le code d’identification des équipements \(ID\)

Lieux de stationnement : Invalidé car validata indique qu’il manque trop de données.
...
[https://docs.google.com/presentation/d/1tOYPkM5ijTgkeo4AdGkaLh2WQLiOXVZ1SEsuOs28FoI/edit\#slide=id.g49a98fd62f\_0\_196](https://docs.google.com/presentation/d/1tOYPkM5ijTgkeo4AdGkaLh2WQLiOXVZ1SEsuOs28FoI/edit#slide=id.g49a98fd62f_0_196)
...
Nous avons appris que nos données seront finalement publiées sur Opendatasoft mais également sur[ datagouv.fr](http://datagouv.fr). Arthur nous a également présenté le programme de la journée.

**10h - 10h30** : Réunion avec Étienne.

Étienne nous a présenté différents outils disponibles sur Opendatasoft.
...
Il nous a également présenté les possibilités relatives aux graphiques sur Opendatasoft.
...
Les bases de données _base horaires administration_ et _petite enfance_ ne prêtent pas à des graphiques, mais à des cartes, que nous souhaitons réaliser directement sur Opendatasoft au regard des tutoriels dont nous avons bénéficié.
...
Étienne a validé nos datavisualisations, et nous a donné des pistes de réflexions pour ajouter des données sur notre carte, grâce à la base de données d’Opendatasoft.

❌ **Difficulté**: Nous n’avons malheureusement pas trouvé de données supplémentaires sur la commune de Nézel sur la base de données d’Opendatasoft… Nous avons voulu rajouter des données d’Openstreetmap mais aucune donnée n’était pertinente pour venir compléter notre cartographie.

**12h30**: Discussion avec Arthur.

Arthur nous a demandé les identifiants du compte opendata.gouv de la commune afin de publier les données. Nous avons donc envoyé un mail à notre interlocuteur et essayé de l’appeler.

❌ **Difficulté** : Pas de réponse de la part de notre interlocuteur, ni par mail ni par téléphone. **13h - 14h** : Pause déjeuner.
...
LIEN FICHES CONTEXTE :[ https://docs.google.com/document/d/1sAs3UsqQkT1-pm8iaQWceWtQ8rQC\_Zh9K6s5HXjPj44/edit](https://docs.google.com/document/d/1sAs3UsqQkT1-pm8iaQWceWtQ8rQC_Zh9K6s5HXjPj44/edit)
...
**Datavisualisation** _**Actes d’état civil**_: prochainement disponible

**Datavisualisation** _**Lieux d’accueil à Nézel**_: prochainement disponible

**Datavisualisation** _**Nézel - base horaires des administrations**_ : prochainement disponible
...
Tout est validé par un contact pour publier une page pour Nézel sur Opendatasoft dans la rubrique commune, ouverte par le GPSEO.

...
- Responsables pour rendre les données disponibles sur le web, les portails open data font la médiation entre les producteurs des données et les réutilisateurs. Ils sont bien souvent les vitrines d'un projet open data. Aujourd'hui, deux tecnologies sont plus visibles : 

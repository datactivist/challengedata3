...
La plateforme data.gouv.fr est **responsable pour la diffusion des données publiques de l'État français**. Crée à la fin de 2011, le portail est piloté par Etalab, administration publique responsable pour la conception et mise en oeuvre de la stratégie d'ouverture des données de l'État.
...
B. Demander l'inscription à une commune déjà existente, dans le cas où votre commune a déjà initié une démarche open data. 

Pensez à demander à votre interlocuteur un logo officiel de la commune au cas où vous devez partir de 0.
...
---
## Publication : bien décrire vos données
...
- Il est temps de bien regarder la disponibilisation de votre fichier en ligne, le téléchager et faire un dernière check pour en eviter des surprises aux réutlisateurs.
